...
public:
  enum {
    ...
    BOOLVAL = 42, TRUE = 43, FALSE = 44, ID = 45, INTVAL = 46, FLOATVAL = 47, 
    CHARVAL = 48, STRING = 49, COMMENT = 50, WS = 51
  };
  ...
  class  Array_acessContext : public ExprContext {
  public:
    Array_acessContext(ExprContext *ctx);
